...
public class VendingMachine {
    ...
    public VendingMachine(Cents[] coinKinds, int selectionButtonCount, int coinRackCapacity, int productRackCapacity, int receptacleCapacity) {
        ...
        PaymentFacade paymentFacade = new PaymentFacade(this);
        CommunicativeFacade communicativeFacade = new CommunicativeFacade(this);
        ProductFacade productFacade = new ProductFacade(this);

        new BusinessRule(paymentFacade, communicativeFacade, productFacade);
    }
